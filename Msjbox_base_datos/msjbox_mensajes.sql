...
CREATE TABLE `mensajes` (
  ...
  CONSTRAINT `mensajes_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id_usuarios`),
  CONSTRAINT `mensajes_ibfk_2` FOREIGN KEY (`id_canal`) REFERENCES `canales` (`id_canales`)
...
-- Dump completed on 2023-09-28 10:55:53
